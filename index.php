                ...
                <div datatype="rdf:HTML" id="content" property="schema:description">
                    ...
                    <section id="join-in" rel="schema:hasPart" resource="#join-in">
                        ...
                        <div datatype="rdf:HTML" property="schema:description">
                            ...
                            <p>This website is here to aggregate relevant <a href="/articles">articles</a> by the self-identifying Linked Research community, and from around the Web. We also list <a href="/resources">tools and techniques</a> for making your research more accessible, <a href="/venues">venues and platforms</a> who are accepting and promoting work which meets our principles, and <a href="/venues#people">examples</a> of Linked Research in the wild. If you have something to include, we'd love to hear from you: let us know in one of our chat channels, send an inbox notification to the appropriate article, or make a PR on github to add yourself.</p>
                        </div>
                    </section>
                </div>
            </article>
