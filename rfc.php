        ...
        <div datatype="rdf:HTML" id="content" property="schema:description">
          ...
          <section id="acid-test" rel="schema:hasPart" resource="#acid-test">
            ...
            <div datatype="rdf:HTML" property="schema:description">
              ...
              <aside>
                <h3>Aside</h3>
                <dl datatype="rdf:HTML" id="challenges" property="schema:description">
                  <dt>Challenges</dt>
                  <dd>
                    <ol>
          ...
          <section id="free-culture" rel="schema:hasPart" resource="#free-culture">
            ...
            <div datatype="rdf:HTML" property="schema:description">
              <p>The authors provide the contribution with a <em>free culture</em> license (e.g., Creative Commons Attribution 4.0 International license, <a href="https://creativecommons.org/licenses/by/4.0/">https://creativecommons.org/licenses/by/4.0/</a>) under the following conditions:</p>
            </div>
          </section>
