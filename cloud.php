        ...
        <div datatype="rdf:HTML" id="content" property="schema:description">
          ...
          <section id="about">
            ...
            <div datatype="rdf:HTML" property="schema:description">
              <p>There is an abundance of scientific information on the Web. However, humans and machines have restricted access, for example due to paywalls and other gatekeeping mechanisms, as well as poor discoverability and linkability. The knowledge industry can better address societal challenges by embracing the virtues of the <em>open</em> Web via decentralisation and interconnectivity of our collective knowledge.</p>

              <p>The <dfn id="lorc">Linked Open Research Cloud</dfn> (<abbr title="Linked Open Research Cloud">LORC</abbr>) project aims to increase the awareness, discovery, and reuse of scholarly communication resources on the Web in the form of open <cite><a href="https://www.w3.org/DesignIssues/LinkedData">Linked Data</a></cite>. We are building an infrastructure to semantically represent all aspects of scholarly communication - from data and research artefacts, to claims within academic articles - as well as to connect resources and the activity around them by means of notifications and visualisations. LORC can assist researchers with finding pertinent scientific information on the Web, and connect their knowledge with the global knowledge graph. For the wider scientific community, LORC can facilitate scientometrics studies and decision making based on the scholarly commons ecosystem.</p>

              <p>This entails both a bottom-up approach to expanding the LORC infrastructure and contents, driven by individual researchers, as well as the higher level social and cultural changes in the academic publishing ecosystem. To this end, this article announces its <em>inbox</em> to receive <cite><a href="https://www.w3.org/TR/ldn/">Linked Data Notifications</a></cite> (<abbr title="Linked Data Notifications">LDN</abbr>) about scholarly activities, eg. publication of scholarly articles, <cite><a href="https://www.w3.org/TR/annotation-model/">Web Annotations</a></cite> (like peer reviews, replies), citations, call for contributions, proceedings, scientific observations and workflows, arguments, funding information etc. With a system like LORC, universal scientific knowledge can be better connected, findable, and accessible, with the potential to amplify its effectiveness and efficiency.</p>
            </div>
          </section>
