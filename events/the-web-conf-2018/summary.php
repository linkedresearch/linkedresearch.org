...
<p>This is an SVG (<a href="https://rawgit.com/solid/solid/master/diagrams/solid-architecture.svg">https://rawgit.com/solid/solid/master/diagrams/solid-architecture.svg</a>), when you find it on the Web you'll be able to read it better.</p>
...
<p><strong>CG</strong>: I love the framework. I'm also evangelising.. How have you thought about disambiguation, authoritative data sources in this framework?</p>
...
<h4>Q&amp;A:</h4>
<p><strong>??</strong>: you are using bit.ly as a shortlink.. I don't know how reliable that is. Real comment - difference between <code>data://</code> and <code>dat://</code> ? And how is topic of module?</p>
<p><strong>CH</strong>: The researcher chooses what to put in the module. Because the network is open by design you can start crawling that information and provide new services to help discovery. We flip from selling access to information to selling services to help consume information, so researchers can look through everything</p>
