                    ...
                    <section id="edsc-participants" rel="schema:hasPart" resource="#edsc-participants">
                        ...
                        <div datatype="rdf:HTML" property="schema:description">
                          ...
                          <ul>
                            ...
                            <li><strong>DD<strong>RT:</strong></strong> Dave de Roure (chair, author)</li>
...
<p><ul><ul class="indent"><li>How does usage influence the previous questions?</li><li>(or should we just get the data out there)</li>
</ul></ul>I'll be talking about practicing what we preach.. Always been a pain point in the semantic web community. We should start doing things ourselves. I think people who are here tend to agree on.. how many of you are publishing RDF in some kind of way. *a few hands* Not too bad.. I'm starting from the assumption that we want to publish our own metadata on the web and we know how it works technically. What are the best starting points. What kind of best practices can we find? This can serve as a starting point as a guide for newcomers. Which are the things they should emphasise.</p>
...
<p><strong>DD<strong>RT:</strong></strong> A few years ago at this conference there was a panel on the future of scholarly comms.. and the whole thing was dominated by the audience laying into EasyChair.</p>
...
<p><strong>DD<strong>RT:</strong></strong> We had interesting problems around IP with the workflows. If someone uses your workflows to generate data, do you have any IP in that? And tagging, there's important IP in tagging. We didn't solve these problems but we did talk with lawyers..</p>
